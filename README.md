# Scheduler OpenAPI Specification
[![Build Status](https://travis-ci.org/noizbuster/redocgeneratetest.svg?branch=master)](https://travis-ci.org/noizbuster/redocgeneratetest)
...
6. If you did everything correct, https://noizbuster.github.io/redocgeneratetest/ will lead to your new docs
...
- Documentation(ReDoc): https://noizbuster.github.io/redocgeneratetest/
- SwaggerUI: https://noizbuster.github.io/redocgeneratetest/swagger-ui/
- Look full spec:
    + JSON https://noizbuster.github.io/redocgeneratetest/swagger.json
    + YAML https://noizbuster.github.io/redocgeneratetest/swagger.yaml
- Preview spec version for branch `[branch]`: https://noizbuster.github.io/redocgeneratetest/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://noizbuster.github.io/redocgeneratetest/ with url from the message: `Server started <url>`
